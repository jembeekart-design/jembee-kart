...
export default function MLMPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f6f6] pb-24">
      {/* HEADER */}
      <div className="sticky top-0 z-50 bg-white/90 backdrop-blur-md px-4 py-3 shadow-sm">
          ...
          <div className="mt-5 rounded-2xl bg-white/10 p-4 backdrop-blur-md border border-white/10">
            {loading ? (
              <div className="flex flex-col items-center justify-center py-6 gap-2">
                ...
                <p className="text-[12px] text-white/70">Fetching credentials...</p>
              </div>
            ) : (
              <>
                ...
                <div className="mt-4 rounded-xl bg-white/10 p-3 text-[11px] break-all font-mono border border-white/5 select-all">
                  {referralLink}
                </div>

                <button
                  onClick={copyReferral}
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-white py-3 text-[14px] font-black text-violet-700 shadow-md active:scale-[0.98] transition-transform"
                >
                  <Copy size={18} />
      ...
      <section className="mt-7 px-4">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <div className="rounded-2xl bg-white p-4 shadow-sm border border-gray-50">
            ...
            <p className="mt-1 text-[11px] text-gray-600">Team se automatic earning.</p>
          </div>

          <div className="rounded-2xl bg-white p-4 shadow-sm border border-gray-50">
            <Users size={28} className="text-fuchsia-600" />
            <h3 className="mt-3 text-[15px] font-black">Unlimited Team</h3>
            <p className="mt-1 text-[11px] text-gray-600">Jitni badi team utni earning.</p>
          </div>

          <div className="rounded-2xl bg-white p-4 shadow-sm border border-gray-50">
            <ShieldCheck size={28} className="text-green-600" />
            <h3 className="mt-3 text-[15px] font-black">Secure System</h3>
            <p className="mt-1 text-[11px] text-gray-600">Safe & transparent income.</p>
          </div>

          <div className="rounded-2xl bg-white p-4 shadow-sm border border-gray-50">
            <BadgeIndianRupee size={28} className="text-orange-600" />
            <h3 className="mt-3 text-[15px] font-black">Daily Earnings</h3>
            <p className="mt-1 text-[11px] text-gray-600">Roz commission earn karo.</p>
          </div>
        </div>
      </section>
    </main>
