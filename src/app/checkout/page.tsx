  ...
  return (
    <main className="min-h-screen bg-[#f8f9fe] pb-32 px-4 max-w-lg mx-auto font-sans">
      ...
      <div className="py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 bg-[var(--card-color)] px-3 py-1.5 rounded-full shadow-sm border border-gray-100">
...
/>
      ...
      <div className="bg-[var(--card-color)] p-5 rounded-3xl border border-gray-50 shadow-sm mb-4">
        ...
        <div className="space-y-2.5 text-xs">
            ...
            <div className="flex justify-between text-[var(--muted-text-color)]"><span>Delivery Charges</span><span className="text-green-600 font-bold">FREE</span></div>
      ...
      {/* FIXED BUTTON */}
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-[var(--card-color)] border-t border-gray-100 rounded-t-3xl shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
