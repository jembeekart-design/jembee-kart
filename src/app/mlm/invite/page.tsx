...
export default function MLMInvitePage() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f6f6] pb-24">
      ...
      <div className="sticky top-0 z-50 bg-white px-4 py-3 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-500">Share Referral Link</p>
          </div>
        </div>
      </div>
      ...
      <section className="mt-6 px-4">
        <div className="rounded-[30px] bg-white p-5 shadow-sm">
          ...
          <div className="mt-5 rounded-2xl bg-gray-100 p-4">
            <p className="text-[11px] text-gray-500">Referral Name</p>
            <h3 className="mt-1 text-[18px] font-black text-gray-900">{referralName}</h3>

            <div className="mt-4 rounded-xl bg-white p-3 text-[11px] font-semibold text-purple-600 break-all select-all">
              {referralLink}
            </div>
          </div>
          ...
          <button
            ...
            className="mt-5 flex w-full items-center justify-center gap-2 rounded-2xl bg-violet-700 py-3 text-[14px] font-black text-white active:scale-[0.99] transition-all disabled:opacity-50"
          >
            <Copy size={18} />
      ...
      <section className="mt-6 px-4">
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            disabled={!referralCode}
            className="rounded-3xl bg-green-500 p-5 text-white shadow-lg active:scale-[0.98] transition-all disabled:opacity-50 text-left"
          >
            <Share2 size={32} />
            <h3 className="mt-4 text-[18px] font-black">WhatsApp</h3>
            <p className="mt-1 text-[11px] text-white/90">Share instantly</p>
          </button>
          ...
          <button
            ...
            disabled={!referralCode}
            className="rounded-3xl bg-sky-500 p-5 text-white shadow-lg active:scale-[0.98] transition-all disabled:opacity-50 text-left"
          >
            <Send size={32} />
            <h3 className="mt-4 text-[18px] font-black">Telegram</h3>
            <p className="mt-1 text-[11px] text-white/90">Invite your network</p>
          </button>
        </div>
      </section>
      ...
      <section className="mt-6 px-4">
        <div className="rounded-[30px] bg-white p-5 text-center shadow-sm">
