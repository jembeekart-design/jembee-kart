...
export default function CouponManagerPage() {
  ...
  return (
    ...
    <main className="min-h-screen bg-[#090909] p-4 text-white">
            ...
            >
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-pink-500 text-black">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <button className="rounded-2xl bg-pink-500 px-4 py-3 font-bold text-black">
      ...
      <div className="mt-8 rounded-[32px] bg-gradient-to-r from-pink-500 to-fuchsia-600 p-7 text-black">
