...
export default function AdminModerationDashboard() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-8 bg-gray-900 text-gray-100 rounded-lg shadow-xl">
      <div className="flex justify-between items-center border-b border-gray-800 pb-4">
        <div>
          <h1 className="text-2xl font-bold">JembeeKart Enterprise Comment Moderation</h1>
          <p className="text-sm text-gray-400">100% Firestore-driven, zero hardcoded rules management panel.</p>
        </div>
