...
> = {
  "theme-config": {
    ...
    description: "Create or repair the Firestore theme configuration document.",
    confidence: 99,
    ...
    patch: {
      ...
      description: "Update theme scanner to use settings/theme.",
      oldCode: "",
      newCode: "",
      autoApplicable: true,
    },
  ...
  "wallet-config": {
    ...
    description: "Create missing wallet fields automatically.",
    confidence: 98,
    ...
    patch: {
      ...
      description: "Update wallet scanner and seed configuration.",
      oldCode: "",
      newCode: "",
      autoApplicable: true,
    },
  ...
  "feature-flags": {
    ...
    description: "Create missing feature flag configuration.",
    confidence: 99,
    ...
    patch: {
      ...
      type: "replace",
      title: "Repair Feature Flags",
      description: "Restore missing feature flags.",
      oldCode: "",
      newCode: "",
      autoApplicable: true,
    },
  ...
  "deployment-version": {
    ...
    description: "Read application version from Firestore.",
    confidence: 99,
    estimatedTime: "15 Seconds",
    ...
    patch: {
      ...
      description: "Read version from settings/version.",
      oldCode: "",
      newCode: "",
      autoApplicable: true,
    },
